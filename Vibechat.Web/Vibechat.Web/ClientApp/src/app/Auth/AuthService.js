...
var AuthService = /** @class */ (function () {
    function AuthService(router, requestsBuilder) {
        this.router = router;
        this.requestsBuilder = requestsBuilder;
    }
    AuthService.prototype.OnUserLoggedIn = function (credentials) {
    ...
    AuthService.prototype.TryAuthenticate = function () {
        return __awaiter(this, void 0, void 0, function () {
            var refreshToken, user, newToken;
    ...
    AuthService.prototype.RefreshToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.requestsBuilder.RefreshJwtToken(refreshToken, this.User.id)];
            });
        });
    };

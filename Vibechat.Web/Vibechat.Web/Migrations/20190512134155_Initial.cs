        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachments_AttachmentKinds_Name",
                        column: x => x.Name,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UsersConvsID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersConversations", x => x.UsersConvsID);
                    table.ForeignKey(
                        name: "FK_UsersConversations_Conversations_ConversationConvID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachmentInfoAttachmentID = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.AttachmentInfoAttachmentID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersConversations_ConversationConvID",
